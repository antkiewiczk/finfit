...
2. **Activity level**: Multiply BMR by activity factor (1.2-1.9)
3. **Add surplus**: 250-500 calories above maintenance
...
**Recommended**: 0.7-1g per pound of bodyweight
**Example**: 180 lb person = 126-180g protein daily

**Best sources**:
1. **Animal proteins**: Chicken, turkey, beef, fish, eggs, dairy
2. **Plant proteins**: Lentils, chickpeas, tofu, tempeh, quinoa
3. **Supplements**: Whey, casein, plant-based protein powders
...
**Recommended**: 2-3g per pound of bodyweight
**Example**: 180 lb person = 360-540g carbs daily
...
### Meal Frequency
**Traditional**: 5-6 smaller meals daily
**Modern approach**: 3-4 meals with snacks
**What matters most**: Total daily intake, not frequency
...
### Water Requirements
**General**: 0.5-1 ounce per pound of bodyweight
**Example**: 180 lb person = 90-180 ounces daily
**Add**: 16-24 ounces per hour of exercise

### Electrolytes
**Important for**: Muscle contractions, nerve function, hydration
**Sources**: Sports drinks (during intense/long workouts), electrolyte tablets, natural foods
...
**Challenges**: Complete protein sources, certain nutrients
**Solutions**:
...
**Common issues**: Dairy, gluten, eggs
**Alternatives**:
...
Remember:
1. **Consistency beats perfection**: 80% adherence yields 100% better results than 100% adherence for 2 weeks
2. **Progress, not perfection**: Small improvements compound over time
3. **Listen to your body**: Adjust based on energy, recovery, results
4. **Patience**: Muscle growth takes time (0.5-1 lb per week is excellent)
5. **Enjoy the process**: Find foods you like, make it sustainable
